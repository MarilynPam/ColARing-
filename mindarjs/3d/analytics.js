...
class ARAnalytics {
  constructor() {
    ...
    this.metrics = {
      ...
      detectionFailures: 0,
      targetStats: {
        raccoon: { found: 0, lost: 0, totalVisibleTime: 0, lastFoundTime: null }
      },
      brightness: [],
      captureAttempts: {
        successful: 0,
  ...
  init() {
    console.log('Analytics initialized with session:', this.metrics.sessionId);
  ...
  trackTargetFound(targetName, targetIndex) {
    ...
    console.log(`Analytics: ${targetName} found at ${detectionTime}ms`);
  }
  ...
  trackTargetLost(targetName, targetIndex) {
    ...
    console.log(`Analytics: ${targetName} lost at ${detectionTime}ms`);
  }
  
  trackDetectionFailure() {
    this.metrics.detectionFailures++;
    console.log('Analytics: Detection failure count:', this.metrics.detectionFailures);
  }
  ...
  generateCSV() {
    ...
    const row = [
      ...
      this.metrics.captureAttempts.failed,
      avgBrightness,
      this.metrics.targetStats.raccoon.found,
      this.metrics.targetStats.raccoon.lost,
      this.metrics.targetStats.raccoon.totalVisibleTime
    ];
  ...
  exportCSV(auto = false) {
    ...
    console.log('Analytics exported:', this.metrics.sessionId);
  }
  ...
  printSummary() {
    ...
    console.log('Raccoon Stats:', this.metrics.targetStats.raccoon);
    console.log('===========================');
  }
}
